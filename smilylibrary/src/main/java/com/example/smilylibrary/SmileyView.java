package com.example.smilylibrary;
...
public class SmileyView extends View {
    ...
    //Paint objects are the brushes of your virtual canvas defining how your geometric  objects are rendered
    ...
    @Override
    protected void onDraw(Canvas canvas) {// draw face
